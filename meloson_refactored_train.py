...
if os.name=="nt":
    ...
    MIDI_DATASET_DIRECTORY="C:\\Users\\037co\\Desktop\\MyStuff\\transformers\\datasets"
    batch_size=512
    epochs=1024
    ...
    #os is mac
    PATH_DIRECTORY_OS_DIVIDER="/"
    MIDI_DATASET_DIRECTORY="/Users/gordonkim/Desktop/myStuff/ML_directory/transformers/"
    epochs=8
    batch_size=64
    sequence_length=256
    DATSET_FILE_SIZE=10
    ...
    #ZIP_FILE_PATH = os.path.join("~/Meloson_Train/datasets", "maestro-v2.0.0-midi.zip")
